...
parser.add_argument('--input_path', type=str, default='outputs_noset_1k/truncated/HumanEval_samples_test_CodeLlama-7b-hf_f32_temp0.8_test_epoch-1.jsonl')
...
if args.dataset == 'mbpp-sanitized':
    ...
    # dataset = load_from_disk("/mnt/c/Users/17385/Desktop/my_datasets/mbpp/full")
...
#     if args.dataset in ('mbpp', 'mbpp-sanitized'):
...
#         handled_solutions[idx]["test"] = build_test_method(raw_data['test_list'], "", method_name)
...
# # More Test Cases
if (args.dataset == 'mbpp') or (args.dataset == 'mbpp-sanitized'):
    test_case_path= '/home/dongyh/A100/self-collaboration-code-gen/data/mbpp_full_test_case.json'
    ...
    test_case_path= '/home/dongyh/A100/self-collaboration-code-gen/data/HumanEval_test_case.jsonl'
    with open(test_case_path, 'r') as f:
...
# print('pass rates - T')
print(pass_at_K(exec_result_T, k=[1]))