...
codegen_source_negative_path = f"outputs_codegen6B_1k_v3_ppl/HumanEval_samples_test_codegen-6B-multi_f32_temp0.0_test_epoch{negative_epoch}.jsonl"
codegen_ground_truth_prob_negative_path = f"probs_codegen_6b_1k_ground_truth_3/HumanEval_samples_test_codegen-6B-multi_f32_temp0.0_test_epoch{negative_epoch}.jsonl"
codegen_source_negative_sample_path = f"outputs_codegen6B_1k_v3_ppl/HumanEval_samples_test_codegen-6B-multi_f32_temp0.8_test_epoch{negative_epoch}.jsonl"
codegen_new_dataset = []
# ---------
...
codellama_source_negative_path = f"outputs_CodeLlama7B_10k_ppl/HumanEval_samples_test_CodeLlama-7b-hf_f32_temp0.0_test_epoch{negative_epoch}.jsonl"
codellama_ground_truth_prob_negative_path = f"probs_codellama_7b_10k_ground_truth_3/HumanEval_samples_test_CodeLlama-7b-hf_f32_temp0.0_test_epoch{negative_epoch}.jsonl"
codellama_negative_sample_path = f"outputs_noset_10k/HumanEval_samples_test_CodeLlama-7b-hf_f32_temp0.8_test_epoch{negative_epoch}.jsonl"
codellama_new_dataset = []

save_path = f"datasets/detect_dataset_all_v3/original_data_contamination_detection_dataset_truncate_epoch{negative_epoch}"
...
new_dataset = codegen_new_dataset
