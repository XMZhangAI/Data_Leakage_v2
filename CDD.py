...
parser.add_argument('--input_path', type=str, default='datasets/DETCON')
...
if __name__ == '__main__':
    if 'gpt' in args.model:
        ...
        codellama_tokenizer = AutoTokenizer.from_pretrained("/data3/public_checkpoints/huggingface_models/CodeLlama-7b-hf/models--codellama--CodeLlama-7b-hf/snapshots/6c284d1468fe6c413cf56183e69b194dcfa27fe6")
        codegen_tokenizer = AutoTokenizer.from_pretrained("Salesforce/codegen-6B-multi", cache_dir="/data3/public_checkpoints/huggingface_models/codegen-6b-multi")
